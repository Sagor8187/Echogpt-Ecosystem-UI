...
const AIJobAnalysisComponent = () => {
  ...
  return (
    <main className="w-full min-h-screen bg-gray-50 dark:bg-gray-950 font-sans flex flex-col items-center pt-12 md:pt-20 px-4 transition-colors duration-300 pb-20">
      ...
      {/* Semantic Header with Gradient Accent */}
      <header className="text-center w-full max-w-4xl mb-12">
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight flex flex-wrap items-center justify-center gap-3">
      ...
      <div className="w-full max-w-4xl flex flex-col gap-8">
            ...
            {featureCards.map((card) => {
              ...
              return (
                <article
                  ...
                  className={`p-6 rounded-2xl border cursor-pointer transition-all duration-300 text-center flex flex-col items-center justify-center min-h-[140px] group backdrop-blur-sm ${
                    isSelected
                      ? 'bg-blue-50/90 dark:bg-blue-950/40 border-blue-600 dark:border-blue-500 shadow-md shadow-blue-500/10 scale-[1.01]'
                      : 'bg-white/80 dark:bg-gray-900/60 border-gray-200/80 dark:border-gray-800 hover:border-blue-500/50 dark:hover:border-blue-500/50 hover:bg-white dark:hover:bg-gray-900 hover:shadow-lg hover:shadow-gray-200/50 dark:hover:shadow-none hover:-translate-y-0.5'
                  }`}
                >
        ...
        <section aria-label="Job Description Input Form">
          <form 
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-3 border-t border-gray-100 dark:border-gray-800/60">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium px-7 py-3 rounded-xl transition-all duration-300 hover:scale-[1.02] active:scale-95 shadow-md shadow-blue-500/20"
              >
...
export default AIJobAnalysisComponent;