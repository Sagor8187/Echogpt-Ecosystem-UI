...
export default function SOPBuilderComponent() {
  ...
  return (
    <main className="w-full min-h-screen bg-gray-50 dark:bg-gray-950 font-sans text-gray-900 dark:text-gray-100 transition-colors duration-300 custom-scrollbar">
      {currentView === 'home' ? (
...
// --- Sub-Component: Home View (Position 1, 2, 3) ---
function HomeView({ onSelectTemplate }: { onSelectTemplate: (id: string) => void }) {
  return (
    <div className="flex flex-col items-center pt-12 md:pt-20 px-4 pb-20 w-full animate-in fade-in duration-500">
      
      {/* 1st Position: Header & Features */}
      <header className="w-full max-w-4xl flex flex-col items-center text-center mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
          <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
            ...
            <h3 className="font-semibold text-lg mb-1">AI-Enhanced</h3>
          ...
          <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
            ...
            <h3 className="font-semibold text-lg mb-1">6 Countries</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Country-specific guidelines</p>
          </div>
          <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
            <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600 dark:text-blue-400 mb-3">
              <FiUsers size={20} />
            </div>
            <h3 className="font-semibold text-lg mb-1">4 Templates</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">Academic, Professional, Research, Creative</p>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {templatesData.map((template) => (
            <article 
              ...
              className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 cursor-pointer hover:border-blue-600 dark:hover:border-blue-500 hover:shadow-md transition-all duration-300 group flex flex-col h-full"
            >
      ...
      <section className="w-full max-w-4xl" aria-label="SOP History">
        <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-3xl p-12 flex flex-col items-center text-center shadow-sm">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-2.5 rounded-xl shadow-md shadow-blue-600/20 active:scale-95 transition-all">
            Create New SOP
          </button>
        </div>
      </section>
...
// --- Sub-Component: Destination Country View (4th Pic) ---
function DestinationView({ onBack }: { onBack: () => void }) {
  return (
    <div className="flex flex-col items-center pt-8 md:pt-16 px-4 pb-20 w-full animate-in slide-in-from-right-8 fade-in duration-500">
        ...
        <section aria-label="Country Selection Grid">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {countriesData.map((country) => (
              <article 
                key={country.id}
                className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:border-blue-600 dark:hover:border-blue-500 hover:shadow-md transition-all duration-300 cursor-pointer group flex flex-col"
              >
                {/* Country Info */}
