...
const ChatHistoryComponent = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50  dark:bg-gray-950 font-sans flex flex-col items-center pt-12 md:pt-20 px-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-3xl flex flex-col sm:flex-row items-start gap-4 mb-24 relative z-10">
        ...
        <div className="relative flex-1 w-full">
          ...
          <input 
            ...
            className="w-full bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800/80 rounded-xl pl-11 pr-4 py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-blue-500 dark:focus:border-blue-500/70 focus:ring-1 focus:ring-blue-500/50 transition-all shadow-sm"
          />
        </div>
        ...
        <div className="relative w-full sm:w-64" ref={dropdownRef}>
          <button 
            ...
            className={`w-full flex items-center justify-between bg-white dark:bg-gray-950 border rounded-xl px-4 py-3 text-left transition-all shadow-sm ${
              isDropdownOpen 
          ...
          {/* Dropdown Menu */}
          {isDropdownOpen && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800/80 rounded-xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 z-50">
      ...
      {/* Empty State Area */}
      <div className="flex-1 flex items-start justify-center w-full max-w-3xl">
