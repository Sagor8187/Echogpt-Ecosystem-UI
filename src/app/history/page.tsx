          ...
          <AnimatePresence>
            {isDropdownOpen && (
              <motion.div 
                ...
                className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800/80 rounded-xl shadow-xl overflow-hidden z-50"
              >
