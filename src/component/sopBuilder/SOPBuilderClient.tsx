...
// --- Main Component ---
export default function SOPBuilderClient() {
...
function HomeView({ onSelectTemplate }: { onSelectTemplate: (id: string) => void }) {
  return (
    <div className="flex flex-col items-center pt-12 md:pt-20 px-4 pb-20 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
          {[
            ...
            <motion.div 
              ...
              className="bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {templatesData.map((template, index) => (
            <motion.article 
              ...
              className="bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 cursor-pointer hover:border-blue-600 dark:hover:border-blue-500 hover:shadow-md transition-colors group flex flex-col h-full"
            >
      ...
      >
        <div className="bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 rounded-3xl p-12 flex flex-col items-center text-center shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {countriesData.map((country, index) => (
              <motion.article 
                ...
                whileHover={{ y: -5, transition: { duration: 0.2 } }}
                className="bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:border-blue-600 dark:hover:border-blue-500 hover:shadow-md transition-colors cursor-pointer group flex flex-col"
              >
                {/* Country Info */}
