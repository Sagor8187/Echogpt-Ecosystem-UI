    ...
    <main className="w-full min-h-screen bg-gray-50 dark:bg-gray-950 font-sans flex flex-col items-center pt-12 md:pt-20 px-4 transition-colors duration-300 pb-20 custom-scrollbar overflow-x-hidden">
      ...
      >
        ...
        <input 
          ...
          className="w-full bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800/80 rounded-2xl pl-12 pr-4 py-4 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:border-blue-500 dark:focus:border-blue-500/70 shadow-sm transition-all"
        />
      </motion.div>
            ...
            {filteredTasks.length > 0 ? (
              filteredTasks.map((task, index) => (
                <motion.article 
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800/80 rounded-2xl p-6 flex flex-col hover:border-blue-500/50 dark:hover:border-blue-500/50 hover:shadow-md transition-colors cursor-pointer group"
                >
                  {/* Icon Container */}
